...
function createData(nicNumber, name, drivingLicenseNumber, address, contactNumber, update, deleted) {
    return {
        nicNumber,
        name,
...
const rows = [
    createData("1234567", "Praboda", "ABC123", "Baddegama", "01234567"),
    createData("7654321", "Sadali", "ABC456", "Hikkaduwa", "02345678"),
    createData("6543218", "Geethika", "ABC789", "Yakkalamulla", "03456789"),
    createData("5432198", "Anupama", "DEF123", "Karapitiya", "04567891")
];
